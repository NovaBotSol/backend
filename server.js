...
async function fetchBirdeyeTokenData(address) {
   try {
       ...
       const response = await fetch(`https://public-api.birdeye.so/public/token_list/${address}`, {
           headers: {
       ...
       console.log('Birdeye Raw Response:', data);
       return data;
   } catch (error) {
...
app.post('/analyze', async (req, res) => {
   try {
       ...
       console.log('API Data received:', { birdeyeData, heliusData });
